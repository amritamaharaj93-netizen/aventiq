          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[#CBD5E1]">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:aventiq34@gmail.com" className="hover:text-[#00C6F7] transition-colors">aventiq34@gmail.com</a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#00C6F7] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+918239988743" className="hover:text-[#00C6F7] transition-colors">8239988743</a>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#00C6F7] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="https://maps.google.com/?q=Kokar+Ranchi" target="_blank" rel="noopener noreferrer" className="hover:text-[#00C6F7] transition-colors">Kokar Ranchi</a>
              </li>
            </ul>
          </div>
        </div>
